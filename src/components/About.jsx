      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start">
        ...
        <div data-aos="fade-left" data-aos-delay="200" className="flex-1 text-white mt-8 md:mt-0 relative z-20">
          ...
          <p className="text-lg font-bold mb-6 leading-relaxed max-w-3xl text-red-50">
            Hi, my name is <span className="text-black text-xl font-black mx-1 tracking-wide uppercase">JAGADESHVARAN P</span>, a dedicated <span className="underline decoration-black decoration-2">MERN Stack Developer</span> focused on crafting high-performance, functional, and deeply scalable web applications.
          </p>
          <p className="text-sm font-medium mb-12 leading-relaxed max-w-3xl text-white/90">
            Experienced in building secure RESTful APIs, optimizing production database systems, and deploying scalable cloud operations within modern agile engineering spaces.
          </p>
